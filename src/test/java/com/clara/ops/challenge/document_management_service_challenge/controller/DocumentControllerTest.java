...
class DocumentControllerTest {
    ...
    void searchDocuments_shouldReturnPageOfDocuments() throws Exception {
        ...
        // Create a PageImpl with total elements count
        ...
        // Create MockMvc with PageableHandlerMethodArgumentResolver and proper message converters
        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(documentController)
    ...
    void getDownloadUrl_shouldReturnDownloadUrl() throws Exception {
        ...
        when(documentService.generateDownloadUrl(1L))
