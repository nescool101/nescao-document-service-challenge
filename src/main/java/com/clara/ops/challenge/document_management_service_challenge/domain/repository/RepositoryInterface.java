...
/**
 * Repository interface for Document domain model in hexagonal architecture. This interface is part
 * of the domain layer and defines the contract that infrastructure implementations must fulfill.
 */
